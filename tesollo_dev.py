...
def draw_joint_angle_labels(frame, lms_xy, cur_pos, target_pos=None):
    ...
    for motor_id in range(1, 21):
        ...
        cur_deg = cur_pos[motor_id] / 10.0  # 0.1deg -> deg [1](https://lginnotek-my.sharepoint.com/personal/psw5495_lginnotek_com/Documents/Microsoft%20Copilot%20Chat%20%ED%8C%8C%EC%9D%BC/%5B%ED%85%8C%EC%86%94%EB%A1%9C%5D%20DG-5F-M_%EC%A0%9C%ED%92%88%20%EC%84%A4%EB%AA%85%EC%84%9C_KR_v1_1_4.pdf)
...
def main():
    ...
    print("      number keys + Enter: motor ON/OFF toggle")
